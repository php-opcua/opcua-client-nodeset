...
use PhpOpcua\Nodeset\TMC\Types\MaterialListType;

/**
 * Codec for the MaterialListType structured data type.
 *
 * @generated
 */
class MaterialListTypeCodec implements ExtensionObjectCodec
{
    /**
     * @param BinaryDecoder $decoder
     * @return MaterialListType
     */
    public function decode(BinaryDecoder $decoder): MaterialListType
    {
        return new MaterialListType(
            $decoder->readString(),
    ...
    public function encode(BinaryEncoder $encoder, mixed $value): void
    {
        ...
        $this->writeArray($encoder, $value->Items, fn ($item) => $encoder->writeExtensionObject($item));
    }
