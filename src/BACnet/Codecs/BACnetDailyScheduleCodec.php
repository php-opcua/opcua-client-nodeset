...
use PhpOpcua\Nodeset\BACnet\Types\BACnetDailySchedule;

/**
 * Codec for the BACnetDailySchedule structured data type.
 *
 * @generated
 */
class BACnetDailyScheduleCodec implements ExtensionObjectCodec
{
    /**
     * @param BinaryDecoder $decoder
     * @return BACnetDailySchedule
     */
    public function decode(BinaryDecoder $decoder): BACnetDailySchedule
    {
    ...
    {
        $this->writeArray($encoder, $value->Day_schedule, fn ($item) => $encoder->writeExtensionObject($item));
    }
