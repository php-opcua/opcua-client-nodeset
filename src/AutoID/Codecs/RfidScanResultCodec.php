...
use PhpOpcua\Nodeset\AutoID\Types\RfidScanResult;

/**
 * Codec for the RfidScanResult structured data type.
 *
 * @generated
 */
class RfidScanResultCodec implements ExtensionObjectCodec
{
    /**
     * @param BinaryDecoder $decoder
     * @return RfidScanResult
     */
    public function decode(BinaryDecoder $decoder): RfidScanResult
    {
    ...
    {
        $this->writeArray($encoder, $value->Sighting, fn ($item) => $encoder->writeExtensionObject($item));
    }
